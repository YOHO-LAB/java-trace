...
/**
 * Well-known {@link Span#tag(String, String) span tag}
 * keys.
 *
...
public class TraceKeys {
	...
	public void setYoho(Yoho yoho) {
		this.yoho = yoho;
	}
	public static class Yoho {
		/**
		 * 用户的ID
		 */
		private String uid = "yoho.uid";

		/**
		 * 用户的ID
		 */
		private String orderCode = "yoho.orderCode";
